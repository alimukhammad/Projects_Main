...
public class Converter {
    ...
    public static void converter()
    {
        ...
        JFrame f = new JFrame("UZBEK CONVERTER ");

        // Creating two labels
        JLabel l1, l2;

        // Creating two text fields.
        // One for som and one for
        // the dollar
        JTextField t1, t2;
        ...
        b1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {
                ...
                // Converting som to dollars
                double d1 = (d / 11223.70);

                // Getting the string value of the
                // calculated value
                String str1 = String.valueOf(Math.round((d1*1000.0))/1000.0);
